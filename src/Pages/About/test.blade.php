...
<head>
    ...
    <link href="{{ asset('frontend/css/jquery.mb.YTPlayer.min.css') }}" media="all" rel="stylesheet"
        type="text/css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <script src="{{ asset('frontend/js/newmain.js') }}"></script>
